...
public class EmpleadoService {
    ...
    public Reunion cancelarReunion(Long id) {
        Reunion reunion = obtenerReunionPorId(id);
    ...
    public Reunion modificarReunion(Long id, Reunion reunionModificada) {
        ...
        if (ahora.isAfter(reunion.getHoraInicio().minusDays(1).withHour(23).withMinute(59))) {
        ...
        reunion.setHoraInicio(reunionModificada.getHoraInicio());
        reunion.setHoraFin(reunionModificada.getHoraFin());
    ...
    public Asistente asistir(Long idReunion, String idUsuario) {
        ...
        LocalDateTime ahora = LocalDateTime.now();
        if (ahora.isBefore(reunion.getHoraInicio()) || ahora.isAfter(reunion.getHoraFin())) {
	...
	/////////////////////////
    private Reunion obtenerReunionPorId(Long id) {
